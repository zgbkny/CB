...
public class ECC {
    ...
    public static void main(String []args) {
    	ECC ecc = new ECC();
    	String inFilePath = "E:\\金山网盘\\#共享#\\生物\\20160128要做的\\data\\TS-PIN.txt";
    	String outFilePath = "E:\\金山网盘\\#共享#\\生物\\20160128要做的\\data\\result\\TS-PIN_ecc.txt";
    	List<String> inList = CommonUtils.getInputFile(inFilePath);
    	Map<String, Integer> dcMap = new DC().calDC(inList);
    	Map<String, List<String>> map = GraphUtils.getGraph(inFilePath);
    	List<String> outList = ecc.calEcc(inList, dcMap, map);
