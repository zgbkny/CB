...
public class produce_subnetworks {
    ...
    //input
    private static String PPInetwork="E:\\金山网盘\\#共享#\\生物\\CDLC算法\\input_data\\DIP_24743.txt";
    private static String expression_data="E:\\金山网盘\\#共享#\\生物\\CDLC算法\\input_data\\expression_value_7079.xls";
    double threshold=0.8;//每个蛋白质分别对应自己的活性阈值,阈值取1时，下面与阈值比较的地方要改为大于等于
    int num=12;//设为12

    //output
    private static String finalpath="E:\\金山网盘\\#共享#\\生物\\CDLC算法\\Result\\subnetworks\\network_";
